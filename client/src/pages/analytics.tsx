...
export default function Analytics() {
  ...
  return (
    <div className="space-y-8">
      {/* Professional 2030 Header - Analytics */}
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-red-100/40 via-red-50/60 to-red-100/40 border-2 border-red-200/30 shadow-2xl dark:from-red-900/20 dark:via-red-800/25 dark:to-red-900/20">
        ...
        <div className="relative p-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-5xl font-bold bg-gradient-to-r from-red-700 via-red-600 to-red-700 bg-clip-text text-transparent mb-3">
                Analytics Intelligence Center
              </h1>
              <p className="text-lg text-slate-700 dark:text-slate-300 font-medium">
                Enterprise procurement analytics with AI-powered anomaly detection and predictive insights
              </p>
            </div>
            <div className="flex items-center gap-4">
              <div className="text-right">
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <p className="font-bold text-red-700">{mockAnalyticsAnomalies.length}</p>
                </div>
              </div>
              <div className="text-right">
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <p className="font-bold text-amber-700">${totalSpend.toLocaleString()}</p>
                </div>
              </div>
              <div className="h-16 w-16 rounded-2xl bg-gradient-to-br from-red-600 to-amber-600 flex items-center justify-center shadow-xl">
